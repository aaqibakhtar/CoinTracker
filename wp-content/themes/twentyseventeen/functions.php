...
add_filter('cron_schedules','my_cron_schedules');
            if(!wp_get_schedule('tweets_fetcher')){
               wp_schedule_event(time(), '5min', 'tweets_fetcher');
            }
			add_action('init','tweets_fetcher',3);
	//-------------------------xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx-------------------------------
...
$content = $connection->get("account/verify_credentials");
  ...
  $tweets = $connection->get("statuses/user_timeline",['count' => 30,'exclude_replies' => true,'screen_name'=>'altmanagerhq','result_type'=>'recent','tweet_mode'=>'extended']);
